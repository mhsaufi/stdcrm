        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-profile">
                        ...
                        <div class="profile">
                            <div class="profile-image">
                                <img src="{{ asset('myasset/logodesignrequest/white_logo.png') }}" alt="John Doe"/>
                            </div>
                    ...
                    <li>
                        <a href="{{ url('/recordusers') }}"><span class="fa fa-user"></span> Users Records</a>                        
                    </li>
                    <li>
                        <a href="{{ url('/recordvendors') }}"><span class="fa fa-users"></span> Vendors List</a>                        
                    </li>
                    <li class="active">
                        <a href="{{ url('/recordevents') }}"><span class="fa fa-th-list"></span> Events Management</a>                        
                    </li>
                </ul>
                <!-- END X-NAVIGATION -->
            </div>
