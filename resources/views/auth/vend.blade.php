  ...
  <body style="background-color: #ecf0f1;">
    ...
    <div id="event" class="section-padding">
      <div class="container" id="form-spaces" style="margin-top: 40px;background-color: white;">
      	...
      	<form action="{{ url('vstep_2') }}" method="POST">
      		@csrf
        <div class="row" style="margin-top: 15px;">
        	...
        	<div class="col-lg-6 col-md-6 col-sm-6">
        		...
        		<label>Your bussiness category</label><br>
        		<select name="com_type" class="form-control">
        			...
        			<option value="boutique">Dresses & Accessories Boutique</option>
        			<option value="makeup">Make Up Artist</option>
        			<option value="florist">Florist & Deco</option>
        			<option value="cards">Printing / Banner / Cards etc</option>
        		</select>
