<div style="width: 100%;display: flex;flex-direction: column;justify-content: flex-start;">
  <div class="external_footer animated fadeInUp fast">
    ...
    <div>
      ...
      <a href="http://www.iium.edu.my/" target="_blank">IIUM</a>
    ...
    <div>
      ...
      <div class="social_page">
        ...
        <div><img src="{{ asset('myasset/img/social/youtube2.png') }}"></div>
        <div><img src="{{ asset('myasset/img/social/twitter2.png') }}"></div>
      </div>
    </div>
  </div>
